  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_scene() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                result4 = [];
                result5 = parse_append();
                while (result5 !== null) {
                  result4.push(result5);
                  result5 = parse_append();
                }
                if (result4 !== null) {
                  result5 = parse_endscene();
                  if (result5 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, scene_desc, choices, appends) { return sceneFunction (scene_desc, choices, appends); })(pos0.offset, pos0.line, pos0.column, result0[2], result0[3], result0[4]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, scene_desc, choices, appends) { return sceneFunction (scene_desc, choices, appends); })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2], result0[3]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
      ...
      function parse_append() {
        var result0, result1, result2, result3;
        var pos0, pos1;
        
        pos0 = clone(pos);
        pos1 = clone(pos);
        if (input.substr(pos.offset, 7) === "#APPEND") {
          result0 = "#APPEND";
          advance(pos, 7);
        } else {
          result0 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, appendix) { return appendix; })(pos0.offset, pos0.line, pos0.column, result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_choice_list() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, prompt, var_name, target) { return ["[\"" + prompt + "\", " + target + ", \"" + var_name + "\"]"]; })(pos0.offset, pos0.line, pos0.column, result0[2], result0[5], result0[7]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, target) { return ["[\"\", " + target + "]"]; })(pos0.offset, pos0.line, pos0.column, result0);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
      ...
      function parse_goto_clause() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column) { return "previousScene"; })(pos0.offset, pos0.line, pos0.column);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
      ...
      function parse_qualified_choose_expr() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, tag, cond, c) { var v = "namedEventCount[\"" + tag + "\"]";
      ...
      function parse_onetime_tag_expr() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column) { return "once" + (++oneTimeCount); })(pos0.offset, pos0.line, pos0.column);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
