  ...
  var result = {
    ...
    parse: function(input, startRule) {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, line, column, s, rest) { return s + rest; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
              }
              if (result0 === null) {
                pos = clone(pos0);
              }
      ...
      function parse_reset_event_count() {
        ...
        pos0 = clone(pos);
        pos1 = clone(pos);
        if (input.substr(pos.offset, 10) === "#UNACHIEVE") {
          result0 = "#UNACHIEVE";
          advance(pos, 10);
        } else {
          result0 = null;
          if (reportFailures === 0) {
            matchFailed("\"#UNACHIEVE\"");
          }
        }
        if (result0 !== null) {
          result1 = parse_spc();
      ...
      function parse_status_page() {
        var result0, result1, result2, result3;
        var pos0, pos1;
        
        pos0 = clone(pos);
        pos1 = clone(pos);
        if (input.substr(pos.offset, 6) === "#STATS") {
          result0 = "#STATS";
          advance(pos, 6);
        } else {
          result0 = null;
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result2 = parse_quoted_text();
            if (result2 !== null) {
              if (input.substr(pos.offset, 9) === "#ENDSTATS") {
                result3 = "#ENDSTATS";
                advance(pos, 9);
              } else {
                result3 = null;
                if (reportFailures === 0) {
                  matchFailed("\"#ENDSTATS\"");
                }
              }
              if (result3 !== null) {
                result0 = [result0, result1, result2, result3];
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, contents) { return "funkscene.makeStatusPage = function() { return " + contents + "; };\n"; })(pos0.offset, pos0.line, pos0.column, result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
