  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "onetime_choose_cycle": parse_onetime_choose_cycle,
        "choose_cycle": parse_choose_cycle,
        "begin_choose_cycle": parse_begin_choose_cycle,
        "choose_cycle_list": parse_choose_cycle_list,
      ...
      function parse_body() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, minigame, rest) { return minigame + rest; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
      ...
      function parse_conjunctive_choice_list() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, cond, target) { return ["((" + cond + ") ? (" + makeGoto(target) + ") : (" + continueIfDefined() + "))"]; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
      ...
      function parse_choose_expr() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, expr, c) { return "((" + expr + ") ? [" + c + "] : [])"; })(pos0.offset, pos0.line, pos0.column, result0[2], result0[3]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, line, column, expr, c) { return "((" + expr + ") ? [" + c + "] : [" + c[0] + "])"; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
      ...
      function parse_qualified_choose_expr() {
        ...
        if (result0 === null) {
          result0 = parse_onetime_choose_cycle();
          if (result0 === null) {
            pos0 = clone(pos);
            pos1 = clone(pos);
            ...
            if (result0 !== null) {
              result0 = (function(offset, line, column, tag, cond, c) { var v = eventCounter(tag);
      ...
      function parse_onetime_choose_cycle() {
        var result0, result1, result2, result3, result4, result5, result6, result7;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result2 = parse_begin_choose_cycle();
            if (result2 !== null) {
              result4 = parse_spc();
              if (result4 !== null) {
                result3 = [];
              ...
              if (result3 !== null) {
                result4 = parse_choose_cycle_list();
                if (result4 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, c, cycles) { cycles.push([]); return makeCycle (c, cycles, false); })(pos0.offset, pos0.line, pos0.column, result0[2], result0[4]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_choose_cycle() {
        var result0, result1, result2, result3, result4, result5;
        var pos0, pos1;
        
        pos0 = clone(pos);
        pos1 = clone(pos);
        result0 = parse_begin_choose_cycle();
        if (result0 !== null) {
          result2 = parse_spc();
          if (result2 !== null) {
            result1 = [];
          ...
          if (result1 !== null) {
            result2 = parse_choose_cycle_list();
            if (result2 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, c, cycles, loop_flag) { return makeCycle (c, cycles, loop_flag); })(pos0.offset, pos0.line, pos0.column, result0[0], result0[2], result0[3]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_begin_choose_cycle() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
        
        pos0 = clone(pos);
        pos1 = clone(pos);
        if (input.substr(pos.offset, 8) === "#ROTATE(") {
          result0 = "#ROTATE(";
          advance(pos, 8);
        } else {
          result0 = null;
        ...
        if (result0 === null) {
          pos0 = clone(pos);
          if (input.substr(pos.offset, 7) === "#ROTATE") {
            result0 = "#ROTATE";
            advance(pos, 7);
          } else {
            result0 = null;
      ...
      function parse_choose_cycle_list() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1, pos2;
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result3 = parse_choose_cycle_list();
              if (result3 !== null) {
                result0 = [result0, result1, result2, result3];
              } else {
                result0 = null;
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, last) { return [last]; })(pos0.offset, pos0.line, pos0.column, result0[0]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
      ...
      function parse_inc_event_count() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, tag) { return incEventCount (tag); })(pos0.offset, pos0.line, pos0.column, result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_reset_event_count() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, tag) { return resetEventCount (tag); })(pos0.offset, pos0.line, pos0.column, result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_query_event_count() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, tag) { return valueOrZero (eventCounter (tag)); })(pos0.offset, pos0.line, pos0.column, result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_status_badge() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, icon, text, expr) { return "((" + expr + ") ? (" + makeIconText(icon,text) + ") : \"\")"; })(pos0.offset, pos0.line, pos0.column, result0[2], result0[6], result0[7]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_meter_bar() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, label, expr, max, units, color) { return makeMeterBar (label, expr, max, units, typeof(color) == 'undefined' ? "undefined" : ("\"" + color + "\"")); })(pos0.offset, pos0.line, pos0.column, result0[1], result0[4], result0[5], result0[6], result0[7]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_meter_bar_unit_clause() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, units) { return " " + units; })(pos0.offset, pos0.line, pos0.column, result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, units) { return units; })(pos0.offset, pos0.line, pos0.column, result0[2]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
      ...
      function parse_status_condition() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, expr) { var tag = badgeEventPrefix + (++badgeCount);
               var counter = eventCounter (tag);
               return "(" + counter + " = " + valueOrZero(counter) + " || " + expr + ")"; })(pos0.offset, pos0.line, pos0.column, result0[0]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
      ...
      function parse_scene_text_or_goto() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, text, target) { return text + "return [__t,[" + makeGoto(target) + "]];"; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_cazoo_intro_text() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, head, t, tail) { return head + " + " + makeDummy("document.title = " + t + ";") + " + " + tail; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[3], result0[5]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
