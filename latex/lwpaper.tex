...
The CFG may be viewed as a generalization of the {\em regular grammar}
(the model underpinning regular expressions).
Just as regular grammars are related to finite-state machines,
CFGs are related to {\em pushdown automata} (finite state machines with pushdown stacks).
