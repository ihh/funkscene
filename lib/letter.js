var LetterWriter = (function(){
	...
	nav.moveListener = moveListener
	nav.cancelMoveListener = cancelMoveListener
	...
	function activateGrammarListener(msg,playerList) {
	    ...
	    listener['grammar'] = client.subscribe (msg.grammarSubscribeChannel(),
						    function(m) {
							cancelGrammarListener()
...
//	    letter.reveal();
	...
	if (this.hasActiveRules (letter)) {
		...
		select.onchange = function() {
		    ...
		    // PUBSUB TODO: broadcast parse tree on parentNode.nodeChannel()
    ...
    lw.Letter.prototype.showUndo = function() { showElement(this.undoDiv) }   // PUBSUB TODO: don't show undo when in multiplayer mode
	...
	if (symbol instanceof LetterWriter.Term)
	    ...
	    if (symbol.isLocallyControlledByHuman())
		this.symbol.nonterminal.attach (this, this.span, this.placeholderSpan, symbol.prompt());
	    else {
		// PUBSUB TODO: attach with preamble & placeholder but no prompt, fire up a moveListener on this.nodeChannel()
		// PUBSUB TODO: implement Node.nodeChannel = function() { return letter.gameMessage.playChannel() + this.nodeChannelSuffix() }
		// PUBSUB TODO: Node.treeJSON()
	    }
	...
	return this.isLocallyControlled() && !this.random();
    }
