var LetterWriter = (function(){
    ...
    lw.Letter = function(grammar,id,undoId) {

	if (typeof(undoId) == 'undefined')
	    undoId = typeof(id) == 'undefined' ? "undo" : id;

	if (typeof(id) == 'undefined')
	    id = "letter";

	if (!document.getElementById (undoId))
	    undoId = id;
	...
	var undoParent = document.getElementById (undoId);
	...
	this.history.push (function() { parent.replaceChild (oldSpan, newSpan); letter.nontermCount -= delta });
	this.showUndo();
    }
