var LetterWriter = (function(){
	...
	nav.changeShowIDE = function() {
		...
		$("#editor,#editorMapContainer,#editorParseTreeContainer,#editorDivider,#showShortcutsCheckboxContainer").show()
		...
		$("#editor,#editorMapContainer,#editorParseTreeContainer,#editorDivider,#showShortcutsCheckboxContainer").hide()
...
//	setLocation()
	...
	if (('scoreParam' in grammar) && typeof(grammar.scoreParam) != 'undefined')
...
//			parentNode.options.push (new lw.Option (rule, option));
		...
		continueButton.innerText = "Continue" + (letter.grammar.isSinglePlayer() ? "" : (" Player " + (1 + parentNode.role)))
...
//		span.appendChild (select);
	...
	this.addMoveListener(false);
	this.placeholderSpan.setAttribute('class','moveListener');
	this.span.appendChild (this.placeholderSpan);
    }
...
//		console.log("Newly-enabled option expanded at " + this.nodeIdentifier())
	...
	if ("client" in this.letter) {
	    ...
	    letter.addMoveListener (id, this.nodeChannel(), moveHandler)
