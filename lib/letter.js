var LetterWriter = (function(){
	...
	addProperty (this, "Phrase @", "id", "text", "The word used to identify this phrase.", grammarEditor.nontermRenamingFilter(nonterm))
	...
	for (var id in this.ruleEditor) {
	    this.ruleEditor[id].hintInput.css ("background-color", random ? "#d0ffff" : "#ffffff")
...
$.event.special.hoverintent = {
	...
	function handler() {
		...
		previousX = currentX;
		previousY = currentY;
		timeout = setTimeout( handler, 400 );
	    }
	}
