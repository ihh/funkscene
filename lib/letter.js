var LetterWriter = (function(){
	...
	for (var id in this.ruleEditor) {
	    // not sure why the following line (changing the background color of the textarea) doesn't work:
	    this.ruleEditor[id].hintInput.css ("background-color", random ? "PaleTurqoise" : "White")
