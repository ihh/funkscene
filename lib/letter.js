var LetterWriter = (function(){
	...
	var addRuleLink = $('<a href="#">Add another option</a>').click(function(e){nontermEditor.addRule()});
...
//	addProperty (this, "Phrase", "@" + nonterm.id);
	...
	var deleteLinkDiv = $('<i><a href="#">Delete option</a></i>').addClass("delete");
	...
	$("#addSliderLink").click(function(e,ui){
