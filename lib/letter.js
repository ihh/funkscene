var LetterWriter = (function(){
	...
	this.randomDiv =
	    addControl ({ property: "random",
			  ...
			  name: "Player",
			  inputDiv: $('<select/>').attr('name','nontermPlayer'+(++nteDummyCount)).append('<option value="0">Human</option><option value="1">Computer</option>'),
			  getInput: function(){return this.inputDiv.val() == "1"},
			  setInput: function(x){this.inputDiv.val(x ? 1 : 0)},
