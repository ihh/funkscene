var LetterWriter = (function(){
	...
	addProperty (this, "Phrase @", "id", {type:"text",parentDiv:propsDiv,parentDiv:propColumn[c++]}, "The word used to identify this phrase.", grammarEditor.nontermRenamingFilter(nonterm))

	addProperty (this, "Pause", "pause", {type:"checkbox",parentDiv:propsDiv,parentDiv:propColumn[c++]}, "If the Pause box is checked, then all text that appears after " + nid + " in any given expansion will be hidden until " + nid + " has been fully expanded. You can achieve the same effect for just a single instance of " + nid + " in your template (as opposed to all instances) by appending a semicolon character after " + nid + " when you use it in an expansion, i.e. \"" + nid + ";\" instead of just \"" + nid + "\".");
	addProperty (this, "Commit", "commit", {type:"checkbox",parentDiv:propsDiv,parentDiv:propColumn[c++]}, "If the Commit box is checked, then after " + nid + " is expanded, the undo history will be cleared: the player will not be able to go back. You can achieve the same effect for just a single instance of " + nid + " in your template (as opposed to all instances) by appending an exclamation point after " + nid + " when you use it in an expansion, i.e. \"" + nid + "!\" instead of just \"" + nid + "\".");
	addProperty (this, "Limit", "maxUsage", {type:"text",parentDiv:propsDiv,parentDiv:propColumn[c++]}, "The Limit field specifies the maximum number of times that the phrase " + nid + " may be used in the document. Leave this blank for no limit.");
