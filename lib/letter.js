...
*/
	...
	var orphan = this.nonterm.isOrphan(this.grammar), loose = this.nonterm.isLooseEnd()
	if (orphan && loose) this.header.append(" (orphan, loose end)")
	else if (orphan) this.header.append(" (orphan)")
	else if (loose) this.header.append(" (loose end)")
    }
