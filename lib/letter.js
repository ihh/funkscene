var LetterWriter = (function(){
	...
	function hideMultiplayerMenu() { 
	    deactivateAll()
	    $("#letter,#slidersContainerParent,#scoreContainerParent,#topLinksContainer,#restart").show()
	...
	function startMultiplayerGame() { 
	    ...
	    $("#multiplayerMenu,#pendingMultiplayer,#restart").hide()
