...
//	    handle: "h3",
	...
	while (typeof(scope.parent) != 'undefined' && !(this.param in scope.paramValue))
	    scope = scope.parent;
	return (this.param in scope.paramValue) ? scope.paramValue[this.param] : undefined;
    }
	...
	if (!this.local)
	    while (typeof(paramScope.parent) != 'undefined' && !(this.param in paramScope.paramValue))
		paramScope = paramScope.parent;
	paramScope.paramValue[this.param] = this.value.evaluate(scope)
    }
