var LetterWriter = (function(){
	...
	nav.Message.prototype.applyPublishChannel = function() { return this.hashChanPlayer('apply',this.playerFingerprints()) }
	nav.Message.prototype.applySubscribeChannel = function() { return this.applyPublishChannel() + '/**' }
	...
	nav.Message.prototype.playChannel = function() { return this.hashChan('play',this.playerFingerprints()) }
	...
	function activateApplicationListener(msg) {
		...
		if (m.gotAllPlayers()) {
		    ...
		    listener['application'] = client.subscribe (m.applyChannel(), applicationListener)
...
//	    letter.reveal();
	...
	if (this.hasActiveRules (letter)) {
		...
		letter.client.publish(parentNode.nodePublishChannel(), msg)
	    }
	    if (this.isHyperlink()) {
...
//	console.log ("Node collapsed: " + this.span.outerHTML);
    ...
    lw.Node.prototype.nodePublishChannel = function() {
	return this.letter.gameMessage.playChannel() + this.nodeIdentifier()
    }

    lw.Node.prototype.nodeSubscribeChannel = function() {
	return this.nodePublishChannel() + '/**'
    }
	...
	this.letter.addMoveListener (this.nodeIdentifier(), this.nodeSubscribeChannel(), moveHandler)
    }
