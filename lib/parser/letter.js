  ...
  var result = {
    ...
    parse: function(input, startRule) {
                    ...
                    if (result6 !== null) {
                      ...
                      if (result7 !== null) {
                        ...
                        if (result8 !== null) {
                          ...
                          if (result9 !== null) {
                            result10 = (function(offset, line, column, mods, lhs, q, n, ppp) {return setNontermProperties(currentLhs(),extend(extend({maxUsage:n,modifiers:mods},q),ppp))})(pos.offset, pos.line, pos.column, result0, result1, result2, result5, result8) ? "" : null;
                            if (result10 !== null) {
                              if (input.charCodeAt(pos.offset) === 123) {
                                result11 = "{";
                                advance(pos, 1);
      ...
      function parse_sym_expr() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, ppp, sym, q) { return makeNontermReference(sym,extend(ppp,q)) })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, ppp, sym, q) { return makeAnonNontermReference(sym,extend(ppp,q)) })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
