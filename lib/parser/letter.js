  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_start() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column) { return [nontermObj, getStart()]; })(pos0.offset, pos0.line, pos0.column);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_rhs() {
        ...
        if (result0 !== null) {
          result1 = parse_hint_with_count();
          if (result1 !== null) {
            result3 = parse_sym_expr();
            if (result3 !== null) {
              result2 = [];
              while (result3 !== null) {
                result2.push(result3);
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, hc, symbols) { addRule(hc[0],symbols,hc[1]) })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
