  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_rule() {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  result5 = parse_placeholder_prompt();
                  if (result5 !== null) {
                    result6 = [];
                    result7 = parse_spc();
                    while (result7 !== null) {
                    ...
                    if (result6 !== null) {
                      result7 = (function(offset, line, column, lhs, pp) {return setLhsDefaults(pp[0],pp[1])})(pos.offset, pos.line, pos.column, result0, result5) ? "" : null;
                      if (result7 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, lhs, pp, rhs) {popLhs()})(pos0.offset, pos0.line, pos0.column, result0[0], result0[5], result0[9]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_rhs() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, hint, symbols) { addRule(hint,symbols) })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
