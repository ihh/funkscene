  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "rhs": parse_rhs,
        "ui_rhs": parse_ui_rhs,
        "hint_with_count": parse_hint_with_count,
        ...
        "sum_weight_expr": parse_sum_weight_expr,
        "product_weight_expr": parse_product_weight_expr,
        "primary_weight_expr": parse_primary_weight_expr,
      ...
      function parse_start() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column) { return { nonterm: nontermObj,
        			       start: getStart(),
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                result4 = (function(offset, line, column, id) { return addScoreParam(id) })(pos.offset, pos.line, pos.column, result2) ? "" : null;
                if (result4 !== null) {
      ...
      function parse_rule() {
                    ...
                    if (result6 !== null) {
                      ...
                      if (result7 !== null) {
                        ...
                        if (result8 !== null) {
                          ...
                          if (result9 !== null) {
                            result10 = (function(offset, line, column, mods, lhs, q, n, ppp) {return setNontermProperties(currentLhs(),extend(extend(extend({maxUsage:n},mods.reduce(LetterWriter.extend,{})),q.reduce(LetterWriter.extend,{})),ppp))})(pos.offset, pos.line, pos.column, result0, result1, result2, result5, result8) ? "" : null;
                            if (result10 !== null) {
                              if (input.charCodeAt(pos.offset) === 123) {
                                result11 = "{";
                                advance(pos, 1);
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, mods, lhs, q, n, ppp) {popLhs()})(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2], result0[5], result0[8]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_hint_with_count() {
        var result0, result1, result2;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, text, n) { return [text, n] })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, text) { return [text, undefined] })(pos0.offset, pos0.line, pos0.column, result0[0]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
      ...
      function parse_max_count() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            if (input.substr(pos.offset, 4) === "most") {
              result2 = "most";
              advance(pos, 4);
            } else {
              result2 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, n) { return n })(pos0.offset, pos0.line, pos0.column, result0[4]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_sum_weight_expr() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
        
        pos0 = clone(pos);
        pos1 = clone(pos);
        result0 = parse_product_weight_expr();
        if (result0 !== null) {
          result1 = [];
      ...
      function parse_product_weight_expr() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1, pos2;
        
        pos0 = clone(pos);
        pos1 = clone(pos);
        result0 = parse_primary_weight_expr();
        if (result0 !== null) {
          result1 = [];
          result2 = parse_linespc();
          while (result2 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                result4 = parse_product_weight_expr();
                if (result4 !== null) {
                  result0 = [result0, result1, result2, result3, result4];
                } else {
                  result0 = null;
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result1 = parse_product_weight_expr();
            if (result1 !== null) {
              result0 = [result0, result1];
            } else {
              result0 = null;
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, l) { return new LetterWriter.ParamFunc ({op:"!",l:l}) })(pos0.offset, pos0.line, pos0.column, result0[1]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
      ...
      function parse_primary_weight_expr() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
        
        pos0 = clone(pos);
        result0 = parse_nonnegative_numeric_literal();
        if (result0 !== null) {
      ...
      function parse_param_func() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, x) { return new LetterWriter.ParamFunc ({op:"$",param:x.toLowerCase()}) })(pos0.offset, pos0.line, pos0.column, result0);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_param_assignment() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, id, expr) { return new LetterWriter.ParamAssignment ({id:id,value:expr,local:true}) })(pos0.offset, pos0.line, pos0.column, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, id, expr) { return new LetterWriter.ParamAssignment ({id:id,value:expr,local:false}) })(pos0.offset, pos0.line, pos0.column, result0[0], result0[4]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, line, column, id, op, increment_expr) { var param_func = new LetterWriter.ParamFunc ({op:"$",param:id.toLowerCase()})
              var rhs_expr = new LetterWriter.ParamFunc ({l:param_func,r:increment_expr,op:op})
              return new LetterWriter.ParamAssignment ({id:id,value:rhs_expr,local:false}) })(pos0.offset, pos0.line, pos0.column, result0[0], result0[2], result0[5]);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, line, column, id) { var param_func = new LetterWriter.ParamFunc ({op:"$",param:id.toLowerCase()})
                ...
                return new LetterWriter.ParamAssignment ({id:id,value:rhs_expr,local:false}) })(pos0.offset, pos0.line, pos0.column, result0[0]);
              }
              if (result0 === null) {
                pos = clone(pos0);
              }
      ...
      function parse_param_expansion() {
        ...
        result0 = parse_clothed_param_id();
        if (result0 !== null) {
          result0 = (function(offset, line, column, id) { return new LetterWriter.ParamReference (id) })(pos0.offset, pos0.line, pos0.column, result0);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, id) { return new LetterWriter.ParamReference (id) })(pos0.offset, pos0.line, pos0.column, result0[0]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
