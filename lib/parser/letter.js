  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "param_symbol": parse_param_symbol,
        "weight": parse_weight
      };
      ...
      function parse_start() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column) { return { nonterm: nontermObj,
        			       ...
        			       paramMin: paramMin,
        			       paramMax: paramMax } })(pos0.offset, pos0.line, pos0.column);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_param_decl() {
        ...
        pos0 = clone(pos);
        if (input.substr(pos.offset, 5) === "param") {
          result0 = "param";
          advance(pos, 5);
        } else {
          result0 = null;
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    result6 = (function(offset, line, column, p, r, v) {return addParam(p,v,r[0],r[1])})(pos.offset, pos.line, pos.column, result0, result2, result4) ? "" : null;
                    if (result6 !== null) {
                      pos1 = clone(pos);
      ...
      function parse_param_range() {
        ...
        if (result0 === null) {
          ...
          result0 = [];
          if (result0 !== null) {
            result0 = (function(offset, line, column) { return ["Never","Always"] })(pos0.offset, pos0.line, pos0.column);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
      ...
      function parse_rule() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result3 = (function(offset, line, column, mods, lhs) {return pushLhs(lhs)})(pos.offset, pos.line, pos.column, result0, result1) ? "" : null;
              if (result3 !== null) {
                result4 = parse_max_count();
                ...
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    ...
                    if (result6 !== null) {
                      result7 = parse_placeholder_prompt();
                      if (result7 !== null) {
                        result8 = [];
                        result9 = parse_spc();
                        while (result9 !== null) {
                        ...
                        if (result8 !== null) {
                          result9 = (function(offset, line, column, mods, lhs, n, pp) {return setNontermProperties(pp[0],pp[1],n,mods)})(pos.offset, pos.line, pos.column, result0, result1, result4, result7) ? "" : null;
                          if (result9 !== null) {
                            if (input.charCodeAt(pos.offset) === 123) {
                              result10 = "{";
                              advance(pos, 1);
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, mods, lhs, n, pp) {popLhs()})(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[4], result0[7]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_sym_expr() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, pp, sym) { return makeNontermReference(sym,pp[0],pp[1]) })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_sum_expr() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, l, r) { return function(ltr){return l(ltr) + r(ltr)} })(pos0.offset, pos0.line, pos0.column, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_primary_expr() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, n) { return function(ltr){return n} })(pos0.offset, pos0.line, pos0.column, result0);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, x) { return function(ltr){return 1 - ltr.paramValue[x]} })(pos0.offset, pos0.line, pos0.column, result0[1]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
          if (result0 === null) {
            ...
            result0 = parse_param_symbol();
            if (result0 !== null) {
              result0 = (function(offset, line, column, x) { return function(ltr){return ltr.paramValue[x]} })(pos0.offset, pos0.line, pos0.column, result0);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
      ...
      function parse_param_symbol() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, s, q) { return s + q })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
