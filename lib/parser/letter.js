  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_start() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column) { return [rules, hint, getStart()]; })(pos0.offset, pos0.line, pos0.column);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_rhs() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, h) { hint[currentLhs()] = h; })(pos0.offset, pos0.line, pos0.column, result0[0]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          pos0 = clone(pos);
          result0 = parse_rhs_list();
          if (result0 !== null) {
            result0 = (function(offset, line, column) { var lhs = currentLhs(); hint[lhs] = defaultHint(lhs); })(pos0.offset, pos0.line, pos0.column);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
      ...
      function parse_rhs_list() {
        ...
        if (result0 !== null) {
          result1 = (function(offset, line, column, rhs) {return addRule(rhs)})(pos.offset, pos.line, pos.column, result0) ? "" : null;
          if (result1 !== null) {
            pos1 = clone(pos);
      ...
      function parse_sym_expr() {
        ...
        if (result0 === null) {
          ...
          result0 = parse_nonterm_symbol();
          if (result0 !== null) {
            result0 = (function(offset, line, column, sym) { return makeSymbol(sym) })(pos0.offset, pos0.line, pos0.column, result0);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, line, column, rhs) { return makeSymbol(popLhs()) })(pos0.offset, pos0.line, pos0.column, result0[2]);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
