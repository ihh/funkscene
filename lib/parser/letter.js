    ...
    parse: function(input, startRule) {
      ...
      function parse_primary_expr() {
        ...
        if (result0 === null) {
          ...
          result0 = parse_param_symbol();
          if (result0 !== null) {
            result0 = (function(offset, line, column, x) { return new LetterWriter.ParamFunc ({op:"?",param:x}) })(pos0.offset, pos0.line, pos0.column, result0);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
