  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_rule() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, mods, lhs, q, maxUsage, ppp) {popLhs()})(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2], result0[5], result0[8]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_hint_with_modifiers() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, text, mods) { return [text, mods.reduce(LetterWriter.extend,{})] })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_times_hidden() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            if (input.substr(pos.offset, 6) === "hidden") {
              result2 = "hidden";
              advance(pos, 6);
            } else {
              result2 = null;
