  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_param_expr() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, x) { return new LetterWriter.ParamFunc ({op:"$",param:x.toLowerCase()}) })(pos0.offset, pos0.line, pos0.column, result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
