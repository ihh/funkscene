  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_start() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column) { return makeGrammar(); })(pos0.offset, pos0.line, pos0.column);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_rhs() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, before, prompt) { var n = getNontermObject(currentLhs()); n.before = before; n.prompt = prompt })(pos0.offset, pos0.line, pos0.column, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, prompt) { getNontermObject(currentLhs()).prompt = prompt })(pos0.offset, pos0.line, pos0.column, result0[0]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
