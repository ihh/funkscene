  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_rule() {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    result6 = parse_placeholder_prompt();
                    if (result6 !== null) {
                      result7 = [];
                      result8 = parse_spc();
                      while (result8 !== null) {
                      ...
                      if (result7 !== null) {
                        result8 = (function(offset, line, column, lhs, n, pp) {return setLhsDefaults(pp[0],pp[1],n)})(pos.offset, pos.line, pos.column, result0, result3, result6) ? "" : null;
                        if (result8 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, lhs, n, pp, rhs) {popLhs()})(pos0.offset, pos0.line, pos0.column, result0[0], result0[3], result0[6], result0[10]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_max_count() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            if (input.substr(pos.offset, 3) === "max") {
              result2 = "max";
              advance(pos, 3);
            } else {
              result2 = null;
