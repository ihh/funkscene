  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "sym_modifiers": parse_sym_modifiers,
      ...
      function parse_rule() {
                ...
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    ...
                    if (result6 !== null) {
                      ...
                      if (result7 !== null) {
                        result8 = parse_placeholder_prompt();
                        if (result8 !== null) {
                          result9 = [];
                          result10 = parse_spc();
                          while (result10 !== null) {
                          ...
                          if (result9 !== null) {
                            result10 = (function(offset, line, column, mods, lhs, q, n, pp) {return setNontermProperties(extend(extend({maxUsage:n,modifiers:mods},q),pp))})(pos.offset, pos.line, pos.column, result0, result1, result2, result5, result8) ? "" : null;
                            if (result10 !== null) {
                              if (input.charCodeAt(pos.offset) === 123) {
                                result11 = "{";
                                advance(pos, 1);
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, mods, lhs, q, n, pp) {popLhs()})(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2], result0[5], result0[8]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_sym_expr() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, pp, sym, q) { return makeNontermReference(sym,extend(pp,q)) })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_sym_modifiers() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, p, c) { return extend(p,c) })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
