                    ...
                    if (result6 !== null) {
                      ...
                      if (result7 !== null) {
                        ...
                        if (result8 !== null) {
                          ...
                          if (result9 !== null) {
                            result10 = (function(offset, line, column, mods, lhs, q, n, ppp) {return setNontermProperties(extend(extend({maxUsage:n,modifiers:mods},q),ppp))})(pos.offset, pos.line, pos.column, result0, result1, result2, result5, result8) ? "" : null;
                            if (result10 !== null) {
                              if (input.charCodeAt(pos.offset) === 123) {
                                result11 = "{";
                                advance(pos, 1);
