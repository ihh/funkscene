  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "cat_string_expr": parse_cat_string_expr,
        "primary_string_expr": parse_primary_string_expr,
      ...
      function parse_hint_text() {
        ...
        pos0 = clone(pos);
        result0 = parse_sum_weight_expr();
        if (result0 !== null) {
          result0 = (function(offset, line, column, f) { return f.asText() })(pos0.offset, pos0.line, pos0.column, result0);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, line, column, tail) { return "$" + tail; })(pos0.offset, pos0.line, pos0.column, result0[3]);
              }
              if (result0 === null) {
                pos = clone(pos0);
              }
      ...
      function parse_param_assignment() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, id, expr) { return new LetterWriter.ParamAssignment ({id:id,value:expr}) })(pos0.offset, pos0.line, pos0.column, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_param_expr() {
        ...
        result0 = parse_sum_weight_expr();
        if (result0 === null) {
          result0 = parse_cat_string_expr();
        }
        return result0;
      }
      
      function parse_cat_string_expr() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
        
        pos0 = clone(pos);
        pos1 = clone(pos);
        result0 = parse_primary_string_expr();
        if (result0 !== null) {
          result1 = [];
          result2 = parse_linespc();
          while (result2 !== null) {
      ...
      function parse_primary_string_expr() {
        var result0;
        var pos0;
