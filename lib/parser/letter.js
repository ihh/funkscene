  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_param_input() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, id) { return new LetterWriter.ParamInput ({type:id[0],id:id[1].toLowerCase(),local:true}) })(pos0.offset, pos0.line, pos0.column, result0[0]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, id) { return new LetterWriter.ParamInput ({type:id[0],id:id[1].toLowerCase(),local:false}) })(pos0.offset, pos0.line, pos0.column, result0[0]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
